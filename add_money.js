const username = localStorage.getItem('rex_local');
if (!username) {
    alert('Please Login First!');
}

const SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbx1HwNrW2meyMr2CTdAtq3g6Mh9LFNsPwGQP8Sz0icZbJGDIPWeIjUYqKuExO5VAdIf/exec';
...
async function uploadToImgur(file) {
    ...
    const response = await fetch('https://api.imgur.com/3/image', {
        method: 'POST',
        headers: {
            'Authorization': 'Client-ID 95c2a4aeb3aee9c'
        },
        body: formData
    });
